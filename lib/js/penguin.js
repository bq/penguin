...
(function($) {
    ...
    var defaults = {
        ...
        transitionDuration: 150 // css transition duration + 50 ms
    };
...
(function($) {
    ...
    $.fn.emulateTransitionEnd = function(duration) {
        ...
        $(this).one('penguinTransitionEnd', function() {
            called = true
        });

        var callback = function() {
            if (!called) $($el).trigger('penguinTransitionEnd')
        };
