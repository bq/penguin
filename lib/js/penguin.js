...
(function($) {
    ...
    Modal.prototype.init = function(options) {
        ...
        if (this.settings.buttons) {
            ...
            this.settings.buttons.align = this.settings.buttons.align ? ' align-' + this.settings.buttons.align : '';
        }
        this.settings.buttonsHtml = this.settings.buttons ? '<div class="modal__footer"><div class="btn-group' + this.settings.buttons.align + '">' + Modal.buttons(this.settings.buttons.btn) + '</div></div>' : '';
